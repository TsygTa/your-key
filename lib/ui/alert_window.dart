              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(_title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.redAccent),textAlign: TextAlign.center, maxLines: 3, overflow: TextOverflow.ellipsis,),
                      Text(_message, style: TextStyle(fontWeight: FontWeight.normal, fontSize: 16, color: Colors.black),textAlign: TextAlign.center, maxLines: 4, overflow: TextOverflow.ellipsis,),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          FlatButton(
                            ...
                            child: Text(okButtonTitle, style: TextStyle(color: Colors.teal)),
                          ),
                          FlatButton(
                            onPressed: _onCancelPressed,
                            child: Text(AppLocalizations.of(_context).translate('cancel'), style: TextStyle(color: Colors.teal)),
                          )
                        ],
                      )
                    ],
